...
Thus in game thoeretical terms one could say that miners reach a Nash equilibrium by behaving in an honest way, since it is the strategy that optimizes their benefits (you can read this interesting [article](https://saltlending.com/game-theory-and-bitcoin/) which goes into further details on the game theoretical aspects of bitcoin mining).
